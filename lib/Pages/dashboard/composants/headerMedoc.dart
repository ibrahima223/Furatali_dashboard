...
class HearderMedoc extends StatefulWidget {
  const HearderMedoc({super.key});

  @override
  State<HearderMedoc> createState() => _HearderMedocState();
}

class _HearderMedocState extends State<HearderMedoc> {
  @override
          ...
          child: Padding(
            ...
            child: Container(
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  context.read<MedocController>().pageIndex = 1;
